...
BUILD_PRELOADER = yes
BUILD_UBOOT = no
CUSTOM_BUILD_VERNO = mx2_ata_v0.3
...
CUSTOM_KERNEL_LCM = st7701_wvga_dsi_vdo_dingsj gc9503v_wvga_dsi_vdo_hsd st7701_wvga_dsi_vdo_ivo gc9503v_wvga_dsi_vdo_boe
...
CUSTOM_KERNEL_TOUCHPANEL = GT5668
CUSTOM_KERNEL_USB = mt6577
CUSTOM_KERNEL_VIBRATOR = vibrator
CUSTOM_LK_LCM = st7701_wvga_dsi_vdo_dingsj gc9503v_wvga_dsi_vdo_hsd st7701_wvga_dsi_vdo_ivo gc9503v_wvga_dsi_vdo_boe
CUSTOM_MODEM = mx2_wcdma_coclock_gprs
CUSTOM_SEC_AUTH_SUPPORT = no
CUSTOM_SEC_SIGNTOOL_SUPPORT = no
CUSTOM_UBOOT_LCM = st7701_wvga_dsi_vdo_dingsj gc9503v_wvga_dsi_vdo_hsd st7701_wvga_dsi_vdo_ivo gc9503v_wvga_dsi_vdo_boe
DISABLE_EARPIECE = no
...
MTK_BT_SUPPORT = yes
MTK_BUILD_VERNO = ALPS.L0.MP2.V1_RATECH6582.WT.L_P10
MTK_BWC_SUPPORT = yes
...
#CREATE_PROJECT_INFO=20141205204311

#Begin For Driver--------------------------------------------------------------------------------
# lisong 2014-12-22 [NO BUGID][add for 82M support HD]start
RGK_82M_SUPPORT_HD = no
# lisong 2014-12-22 [NO BUGID][add for 82M support HD]end
...
#add OTA dexin.su 20141212 start
RGK_OTA_SUPPORT = yes
#add OTA dexin.su 20141212 end

#add BUG_ID:DELQ-183 zengchuiguo 20130830 (start)
RGK_INTERNAL_SD_VOLUME_NAME = J511
#add BUG_ID:DELQ-183 zengchuiguo 20130830 (end)

#modify BUG_ID:JWLW-1205 zengchuiguo 20140125 (start)
RGK_MTP_LABEL = Ragentek J511
RGK_PTP_LABEL = Ragentek J511
#modify BUG_ID:JWLW-1205 zengchuiguo 20140125 (end)
#add BUG_ID:JBLW-482 zhangyuwen 20141216 (start)
RGK_SUPPORT_MESSAGE_BLACKLIST = yes
#add BUG_ID:JBLW-482 zhangyuwen 20141216 (end)
#add by liuxianbang for theme change 20141222 (start)
RGK_Theme_SUPPORT = yes
#add by liuxianbang for theme change 20141222 (end)

# A:None huangkunming 20141224 @{
RGK_SCROLL_RECOVERY_MENU = yes
# @}

#add JWLYLL-127 songqingming 20150215 (start)
RGK_NETMANAGER_APP_SUPPORT = yes
#add JWLYLL-127 songqingming 20150215 (end)
# mdedia file
MTK_PRELOAD_FILE_SUPPORT = yes
